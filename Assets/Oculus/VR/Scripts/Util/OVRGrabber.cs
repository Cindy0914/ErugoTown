...
public class OVRGrabber : MonoBehaviour
{
    ...
    protected void GrabEnd()
    {
        if (m_grabbedObj != null)
        {
            ...
            GrabbableRelease(linearVelocity * throwSpeed, angularVelocity);
        }
    ...
    {
        StartCoroutine(VibrateController(0.1f, 0.3f, 0.2f,m_controller));
    ...
    protected IEnumerator VibrateController(float waitTime, float frequency, float amplitude, OVRInput.Controller controller = OVRInput.Controller.Active)
    {
